...
const MyPage = () => {
    ...
    const fetchUserData = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/user/my-page', {
    ...
    const fetchFinishedProducts = async (userId) => {
        try {
            const response = await axios.get(`http://127.0.0.1:8000/medaka/${userId}/finished`, {
                withCredentials: true
            });
    ...
    const handleSaveChanges = async (event) => {
        ...
        if (icon) {
            ...
            reader.onload = async () => {
                ...
                try {
                    await axios.put('http://127.0.0.1:8000/auth/user/update', {
                        nickname,
                        password,
                        icon: iconBase64
                    }, {
