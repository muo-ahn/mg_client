...
const AdminDashboard = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get('https://0nusqdjumd.execute-api.ap-northeast-2.amazonaws.com/default/admin/users', { withCredentials: true });
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get('https://0nusqdjumd.execute-api.ap-northeast-2.amazonaws.com/default/admin/products', { withCredentials: true });
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get('https://0nusqdjumd.execute-api.ap-northeast-2.amazonaws.com/default/admin/orders', { withCredentials: true });
  ...
  const createOrder = async (order) => {
    try {
      await axios.post('https://0nusqdjumd.execute-api.ap-northeast-2.amazonaws.com/default/admin/orders', order, { withCredentials: true });
      fetchOrders();
    } catch (error) {
      alert("입력을 확인해주세요");
  ...
  const updateOrder = async (orderId, updatedOrder) => {
    try {
      await axios.put(`https://0nusqdjumd.execute-api.ap-northeast-2.amazonaws.com/default/admin/orders/${orderId}`, updatedOrder, { withCredentials: true });
      fetchOrders();
    } catch (error) {
  ...
  const deleteOrder = async (orderId) => {
    try {
      await axios.delete(`https://0nusqdjumd.execute-api.ap-northeast-2.amazonaws.com/default/admin/orders/${orderId}`, { withCredentials: true });
      fetchOrders();
    } catch (error) {
