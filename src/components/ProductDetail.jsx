...
const ProductDetail = () => {
  ...
  useEffect(() => {
    axios.get(`https://medakaauction.com/medaka/${id}`)
      .then(response => {
      ...
      .then(sellerId => {
        return axios.get(`https://0nusqdjumd.execute-api.ap-northeast-2.amazonaws.com/default/seller/${sellerId}`);
      })
      .then(response => {
    ...
    const socket = new WebSocket(`wss://10.0.137.166:8000/medaka/update_bid/${id}`);
